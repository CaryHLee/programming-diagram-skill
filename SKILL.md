...
description: 将程序或系统的模块调用关系与步骤顺序渲染为简洁 HTML 页面：flowchart 思维导图 + sequenceDiagram UML 时序图，内置本地化 mermaid 引擎与既定版式。只要阅读大量代码时就使用，或当用户要求“画调用关系/流程逻辑”“做思维导图和时序图页面”或“整理代码架构”时使用。
version: 0.1.0
author:Cary
---
